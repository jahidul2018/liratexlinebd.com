                        ...
                        <div id="pl-33"  class="panel-layout" >
                                                    ...
                                                    <div id="pgc-33-4-1"  class="panel-grid-cell" ><div id="panel-33-4-1-0" class="so-panel widget widget_text panel-first-child panel-last-child" data-index="6" >
                                                        <div style="text-align: left;" data-title-color="#ffffff" data-headings-color="#443f3f" class="panel-widget-style panel-widget-style-for-33-4-1-0" >
                                                            ...
                                                            <div class="textwidget">
                                                                <p>LIRA TEXLINE BD has a combined 5 years’ experience in the apparel industry. Such an extensive background has established us as a 
                            ...
                            <div id="pgc-33-5-1"  class="panel-grid-cell" >
                                <div id="panel-33-5-1-0" class="so-panel widget widget_media_image panel-first-child panel-last-child" data-index="8" >
                                    ...
                                    class="panel-widget-style panel-widget-style-for-33-5-1-0" ><img width="1024" height="768" src="{{ asset('/frontend/wp-content/uploads/collage-1024x768.jpg') }}"
                                 ...
                                 data-overlay="true" data-overlay-color="#000000" class="panel-row-style panel-row-style-for-33-7" ><div id="pgc-33-7-0"  class="panel-grid-cell" >
                                     <div id="panel-33-7-0-0" class="so-panel widget widget_text panel-first-child panel-last-child" data-index="11" >
                                         <div style="text-align: left;" data-title-color="#443f3f" data-headings-color="#443f3f" class="panel-widget-style panel-widget-style-for-33-7-0-0" >
                                            ...
                                            <div class="textwidget"><p>We have our own 4 sweater manufacturing factories near Dhaka. Here more then 12,000 workers are operating for last 21 years.</p>
                            <p>With more then 500 production stuffs, our monthly export is over 700,000pcs of sweaters. All the factories are around Dhaka and always in communication with the Lira Text   office in Baridhara DOHS. We have separate design section in each factory for production and R&amp;D.</p>
                            <p>Apart form our own factories; we also produce in more than 15 sweater factories in Dhaka and Chittagong and 10 knit and woven factories. In total our average monthly export in sweater is around a million pieces and knit/woven around half a million pieces.</p>
                            </div>
                                                     ...
                                                     <div id="pgc-33-8-1"  class="panel-grid-cell" >
                                                         <div id="panel-33-8-1-0" class="so-panel widget widget_text panel-first-child panel-last-child" data-index="14" >
                                                             ...
                                                             class="panel-widget-style panel-widget-style-for-33-8-1-0" >		
                                                             	<div class="textwidget"><p>Our focused and well trained QA teams are working in every key check point of the manufacturing stages to attain the customers required quality standards. Starting from sample approval to the final production stages, our QCs are always monitoring and supervising the factory people. To achieve the stiff target of attaining the high standards, we allocate individual QA teams for individual clients, working around the clock in every factory we produce at.</p>
                            <p>These teams at the factories are centrally monitored and regulated by the QA department stationed at Lira Text   Fashion head office on a daily basis. Consequently, our efficient quality control system has enabled us to meet the AQL standards set by the clients.</p>
                            <p>In order to better ourselves, we have developed a chain of procedures to ensure our required standards are met to maximize production and minimize wastage. And this also ensures on time shipment according to plan.</p>
                            <ul>
                            ...
                            <p>We push ourselves to the limit to make sure that the chain of procedures mentioned above are followed every time for every order.</p>
                            </div>
                            ...
                            <p>All three of our own manufacturing units are 100% compliance. We are certified by globally recognized Auditing Companies. Over the time we have accumulated BSCI, SEDEX, WRAP, ACORD, OEKO-TEX, ITX, WALMART etc.</p>
                            <p>We have internal compliance teams stationed in each of our factories, up keeping the compliance standards mentioned above regularly. These teams report directly to our central Compliance Department stationed in Lira Text   head office.</p>
                            </div>
                                ...
                                <div id="panel-33-9-1-0" class="so-panel widget widget_media_image panel-first-child panel-last-child" data-index="16" >
                                    <div style="text-align: center;" id="compliance" data-title-color="#443f3f" data-headings-color="#443f3f"
                                     ...
                                     sizes="(max-width: 638px) 100vw, 638px" /></div></div></div></div></div><div id="pg-33-10"  class="panel-grid panel-has-style" >
                                         <div style="background-image: url('/frontend/wp-content/uploads/commercial.png');padding: 100px 0; " data-hasbg="hasbg" data-overlay="true" data-overlay-color="#000000" 
